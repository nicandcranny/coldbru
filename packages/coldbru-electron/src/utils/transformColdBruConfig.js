...
const { transformProxyConfig } = require('@coldbru/requests');

function transformColdBruConfigBeforeSave(brunoConfig) {
...
async function transformColdBruConfigAfterRead(brunoConfig, collectionPathname) {
