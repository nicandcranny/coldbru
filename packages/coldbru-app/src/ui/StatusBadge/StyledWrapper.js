 ...
 *
 * @see packages/coldbru-app/src/themes/schema/oss.js — status schema
 * @see packages/coldbru-app/src/themes/light/light.js — light theme tokens
 */
 ...
 *
 * @see packages/coldbru-app/src/themes/light/light.js — radius: { sm: '4px', base: '6px', md: '8px', lg: '10px', xl: '12px' }
 */
