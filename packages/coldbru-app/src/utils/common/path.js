 ...
 *
 * Bruno stores relative paths in configuration files (coldbru.json) that are committed to version control.
 ...
 * - When a Windows user commits a coldbru.json with Windows-style paths, Unix users cannot resolve these paths
