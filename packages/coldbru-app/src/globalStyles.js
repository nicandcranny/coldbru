...
const GlobalStyle = createGlobalStyle`
  ...
  .CodeMirror-coldbruVarInfo :first-child {
    margin-top: 0;
  }

  .CodeMirror-coldbruVarInfo :last-child {
    margin-bottom: 0;
  }

  .CodeMirror-coldbruVarInfo p {
    margin: 1em 0;
  }
  ...
  /* Header */
  .CodeMirror-coldbruVarInfo .var-info-header {
    display: flex;
    align-items: center;
  ...
  .CodeMirror-coldbruVarInfo .var-name {
    font-size: ${(props) => props.theme.font.size.base};
    color: ${(props) => props.theme.dropdown.color};
    font-weight: 500;
    flex: 1;
  ...
  /* Scope Badge */
  .CodeMirror-coldbruVarInfo .var-scope-badge {
  ...
  /* Value Container */
  .CodeMirror-coldbruVarInfo .var-value-container {
    position: relative;
  ...
  .CodeMirror-coldbruVarInfo .var-value-display {
  ...
  .CodeMirror-coldbruVarInfo .var-value-editor {
    width: 100%;
  ...
  .CodeMirror-coldbruVarInfo .var-value-editor .CodeMirror {
    height: 100%;
    min-height: 1.75rem;
    max-height: 11.125rem;
    font-size: ${(props) => props.theme.font.size.base};
  ...
  .CodeMirror-coldbruVarInfo .var-value-editor .CodeMirror-scroll {
    min-height: 1.75rem;
    max-height: 11.125rem;
  ...
  .CodeMirror-coldbruVarInfo .var-value-editor .CodeMirror-focused {
    background: ${(props) => props.theme.input.bg};
    border-color: ${(props) => props.theme.input.focusBorder};
  }

  .CodeMirror-coldbruVarInfo .var-value-editor .CodeMirror-lines {
    padding: 0.375rem 1.5rem 0.375rem 0.5rem;
  ...
  .CodeMirror-coldbruVarInfo .var-value-editor .CodeMirror pre {
    font-size: ${(props) => props.theme.font.size.base};
    font-family: Inter, sans-serif;
    font-weight: 400;
    line-height: 1.25rem;
  ...
  .CodeMirror-coldbruVarInfo .var-value-editor .CodeMirror-line {
    padding: 0;
    max-width: 13.1875rem;
    line-height: 1.25rem;
    font-size: ${(props) => props.theme.font.size.base};
  ...
  .CodeMirror-coldbruVarInfo .var-value-editor .CodeMirror-sizer {
  ...
  .CodeMirror-coldbruVarInfo .var-value-editable-display {
    width: 17.1875rem;
    max-width: 13.1875rem;
    padding: 0.375rem 1.5rem 0.375rem 0.5rem;
    font-size: ${(props) => props.theme.font.size.base};
  ...
  /* Icons Container */
  .CodeMirror-coldbruVarInfo .var-icons {
    position: absolute;
    top: 0.375rem;
    right: 0.5rem;
    display: flex;
  ...
  .CodeMirror-coldbruVarInfo .secret-toggle-button,
  .CodeMirror-coldbruVarInfo .copy-button {
    background: transparent;
    border: none;
    cursor: pointer;
    padding: 0.125rem;
  ...
  .CodeMirror-coldbruVarInfo .secret-toggle-button:hover,
  .CodeMirror-coldbruVarInfo .copy-button:hover {
    opacity: 1;
  }

  .CodeMirror-coldbruVarInfo .copy-success {
    color: ${(props) => props.theme.colors.text.green} !important;
  }

  /* Read-only Note */
  .CodeMirror-coldbruVarInfo .var-readonly-note {
    font-size: ${(props) => props.theme.font.size.xs};
  ...
  .CodeMirror-coldbruVarInfo .var-warning-note {
    font-size: 0.75rem;
