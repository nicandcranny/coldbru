import postmanToBruno from '../src/postman/postman-to-coldbru.js';
...
describe('Postman to Bruno Converter with Examples', () => {
  ...
  test('should convert Postman collection with examples to Bruno format', async () => {
    ...
    expect(successExample.request.url).toBe('http://localhost:8081/ping');
    ...
    expect(errorExample.request.url).toBe('http://localhost:8081/ping');
