import type { Item as BrunoItem } from '@coldbru/schema-types/collection/item';
...
import type { KeyValue as BrunoKeyValue } from '@coldbru/schema-types/common/key-value';
