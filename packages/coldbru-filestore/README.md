...
A generic file storage and parsing package for the ColdBru API client.

## Purpose

This package abstracts the file format operations for ColdBru, providing a clean interface for parsing and stringifying requests, collections, folders, and environments.

## Features

- Format-agnostic APIs for file operations
- Currently supports ColdBru's custom `.bru` format
